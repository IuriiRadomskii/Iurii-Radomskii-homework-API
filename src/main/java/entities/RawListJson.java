...
public class RawListJson {
    ...
    public String toString() {
        ...
        sb.append(RawListJson.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RawListJson) == false) {
            return false;
        }
        RawListJson rhs = ((RawListJson) other);
